...
def get_dictionary():
	...
	##读取各个词的权重信息
	loop = 8
	dictionary_1 =corpora.Dictionary.load('/home/mirage/sentiment/subjective_54W_'+str(loop)+'829.dict')
	step1_score = {}
	with open('/home/mirage/sentiment/new_emoticon_54W_'+str(loop)+'829.txt') as f:
	    for l in f:
	        lis = l.rstrip().split()
	...
	dictionary_2 =corpora.Dictionary.load('/home/mirage/sentiment/polarity_270W_'+str(loop)+'829.dict')
	step2_score = {}
	with open('/home/mirage/sentiment/polarity_270W_'+str(loop)+'829.txt') as f:
	    for l in f:
	        lis = l.rstrip().split()
